  ...
  return (
    <Container>
      <video autoPlay muted loop id="myVideo">
        <source src={videoUrl || '/video/video-1.mp4'} type="video/mp4" />
      </video>
...
const Container = styled.div`
  ...
  &::before {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(to bottom, rgba(0,0,0,.6) 0%, rgba(0,0,0,.4) 20%, rgba(0,0,0,.6) 50%);
    z-index: -1;
}
  video{
    position: absolute;
    ...
    height:100%;
    z-index: -2;
    ${()=>respond({min: 669},'width:100%; height: auto; top: 0;')}
  }
`